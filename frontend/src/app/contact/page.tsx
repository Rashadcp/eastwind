...
const defaultContactPage: ContactPageData = {
  ...
  heroDescription: "Get in touch with our team for technical inquiries, quotations, or safety consultations in Saudi Arabia.",
  communicationsTagline: "",
  ...
  marketSegments: [
    ...
    { value: "power-utilities", label: "Utility Systems & Energy Grids" },
    { value: "marine-offshore", label: "Marine & Offshore Platforms" }
  ],
  submitButtonText: "Send Message",
  successTitle: "Message Sent",
  successMessage: "Thank you. Your message has been sent to our team in Dammam. A specialist will follow up within 24 hours."
};
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white text-slate-800 antialiased flex flex-col w-full overflow-x-hidden">
        ...
        <div className="w-full bg-white py-16 sm:py-20 flex-grow">
          <div className="max-w-[1240px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-start">
              ...
              <div className="space-y-6">
                ...
                <div className="border-t border-slate-100 pt-6 space-y-3.5">
                  <div className="flex items-center gap-4 text-xs text-slate-600 font-light">
                    ...
                    <span>Email: <a href={`mailto:${contactInfo.email}`} className="text-[#c22026] font-semibold no-underline hover:underline">{contactInfo.email}</a></span>
                  </div>
                  <div className="flex items-center gap-4 text-xs text-slate-600 font-light">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-slate-400">
                      <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" />
                    </svg>
                    <span>Phone: <span className="text-slate-900 font-semibold">{contactInfo.telephone}</span></span>
                  </div>
                  <div className="flex items-center gap-4 text-xs text-slate-600 font-light">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-slate-400">
                    ...
                    <span>Working Hours: <span className="text-slate-900 font-medium">{contactInfo.workingHours}</span></span>
                  </div>
                </div>
              </div>
            </div>
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    {/* Company */}
                    <div className="space-y-1.5">
                      <label className="text-[11px] font-bold uppercase tracking-wider text-slate-600 block">Company Name</label>
                      <input
                        type="text"
                        required
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    {/* Email */}
                    <div className="space-y-1.5">
                      <label className="text-[11px] font-bold uppercase tracking-wider text-slate-600 block">Email Address</label>
                      <input
                        type="email"
                        required
                  ...
                  >
                    {contactPage.submitButtonText?.includes("Transmit") ? "Send Message" : (contactPage.submitButtonText || "Send Message")}
